    ...
    <div className="navbar">
      ...
      <ul className="nav-lista">
        <li className="nav-item">
          <a className="nav-item-a" data-selected href="/">
            <MenuCardapio className="icon-svg" />
            pedidos
          </a>
          <div className="nav-list-sub">
            <a className="nav-item-a-sub" data-selected href="/pedidos/abertos">Em aberto</a>
            <a className="nav-item-a-sub" href="/pedidos/encerrados">Encerrados</a>
          </div>
        </li>
        <li className="nav-item">
          <a className="nav-item-a" href="/userorders">
            <MenuCliente className="icon-svg" />
            {' '}
            cliente
          </a>
        </li>
