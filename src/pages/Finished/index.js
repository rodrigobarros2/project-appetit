...
import {
  GridContainer, Titulo, Button, Container1, Container2, Profile,
} from './styles';
    ...
    <GridContainer>
      ...
      <div>
        ...
        <Container2>
          <a href="/">
            {' '}
            <Button cor="rgba(0, 0, 0, 0.88);" bg="transparent" border="2px solid rgba(0, 0, 0, 0.88);">Voltar para lista de pedidos</Button>
          </a>
